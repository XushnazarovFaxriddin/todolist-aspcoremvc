...
namespace ASPNETCoreMVCtodoList.Models
{
    public class MockTodoRepository : ITodoRepository
    {
        ...
        public MockTodoRepository()
        {
            ...
            {
                new Todo(){Id = 1, IsCheckend=false, Name="Faxriddin",deta=new DateTime(2015, 12, 31),Color=Colors[random.Next(0,Colors.Length)]},
                ...
                new Todo(){Id = 4, IsCheckend=true, Name="Numuhammad",deta=new DateTime(2018,02,23),Color=Colors[random.Next(0,Colors.Length)]},
